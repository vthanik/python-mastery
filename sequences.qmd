...
```{mermaid}
flowchart TB
  subgraph Container["Container — any types, holds references"]
    CM["Mutable: list, deque"]
    CI["Immutable: tuple"]
  end
  subgraph Flat["Flat — one type, packed values"]
    FM["Mutable: bytearray, array.array"]
    FI["Immutable: str, bytes"]
  end
```
