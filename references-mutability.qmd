...
- `weakref.ref(s1)` creates a *weak* reference object. Unlike a regular variable assignment (`s2 = s1`, which would bump the reference count), a weak ref does not count toward keeping the object alive.
