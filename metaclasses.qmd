...
The rule, in plain English: if you think you need a metaclass, you probably don't. Try `__init_subclass__` first; try a class decorator second; reach for a metaclass only when both fail.
