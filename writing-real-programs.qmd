...
## Build: a small grading module with inline tests {#sec-real-build}
...
**Step 3: inline tests in the three pytest shapes.** Without pytest installed in this notebook, plain `assert`s — bunched into a tiny test runner — produce a pass/fail report in the same style:
