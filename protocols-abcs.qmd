...
ABCs also support *virtual subclasses* — registering an unrelated class as a subclass without inheritance:
...
The standard library has already registered `tuple` and `list` as `Sequence` subclasses.
