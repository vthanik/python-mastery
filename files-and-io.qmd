...
Start from first principles. When a user runs `python myscript.py data.json -v`, what does Python actually hand to your program? Just a list of strings — `sys.argv`:
